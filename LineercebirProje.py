...
if SECILEN:
    ...
    if is_video:
        print(f"[İŞLEM] Video yerel diskten alındı. YOLOv8 ile simüle ediliyor: {SECILEN}")
        ...
        if not cap.isOpened():
            ...
            clear_output()
            print(f"[BAŞARILI] Video analizi tamamlandı. Grafik raporları basılıyor...\n")
        ...
        # Görsel Analiz Modu
        print(f"[İŞLEM] Görsel yerel diskten alındı. 3 kanallı panel oluşturuluyor: {SECILEN}")
        ...
        if img is not None:
            ...
            print("[BAŞARILI] 3 Kanallı görsel analizi tamamlandı ve 'analiz_sonuc_gorsel.png' aduyla kaydedildi.")
        else:
